using InformationBox.Classes.Controls;
...
namespace InformationBox.Controls
{
    /// <summary>
    /// Glass button
    /// </summary>
    [Category("Glass Components"), DefaultEvent("Click"), DefaultProperty("Text"), Description("Button with glass look and feel"), ToolboxBitmap(typeof(Button))]
    public partial class GlassButton : Control
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="GlassButton"/> is pushed.
        /// </summary>
