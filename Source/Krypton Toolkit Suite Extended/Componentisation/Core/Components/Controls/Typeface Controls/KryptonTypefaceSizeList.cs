...
namespace KryptonToolkitSuiteExtendedCore.Components.Controls
{
    public class KryptonTypefaceSizeList : UserControl
    {
        ...
        private ComponentFactory.Krypton.Toolkit.KryptonListBox klstSizes;
        private ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown knumSizes;

        private void InitializeComponent()
        {
            this.knumSizes = new ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown();
            this.klstSizes = new ComponentFactory.Krypton.Toolkit.KryptonListBox();
            this.SuspendLayout();
            // 
            // knumSizes
            // 
            ...
            this.knumSizes.StateCommon.Content.TextH = ComponentFactory.Krypton.Toolkit.PaletteRelativeAlign.Inherit;
