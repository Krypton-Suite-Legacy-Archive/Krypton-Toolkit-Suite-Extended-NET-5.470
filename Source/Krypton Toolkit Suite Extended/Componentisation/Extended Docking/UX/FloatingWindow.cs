...
namespace ExtendedDocking
{
    ...
    /// </summary>
    internal sealed class FloatingWindow : KryptonForm, IFloatingWindow
    {
        ...
        private DockingExtender _dockExtender;
        ...
        public FloatingWindow(DockingExtender dockExtender)
        {
        ...
        protected override void OnResizeEnd(EventArgs e)
        {
            if (_dockExtender.Overlay.Visible == true && _dockExtender.Overlay.DockHostControl != null) //ok found new docking position
            {
                ...
                DockFloatingWindow(); // dock the container
            }
