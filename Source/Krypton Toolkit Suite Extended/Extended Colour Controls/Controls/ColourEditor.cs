...
namespace ExtendedColourControls
{
    public class ColourEditor : UserControl, IColourEditor
    {
        ...
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblRGB;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblRed;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblGreen;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblBlue;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblHex;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblAlpha;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblLuminosity;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblSaturation;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblHue;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel klblHSL;
        private ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown knudRed;
        private ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown knudSaturation;
        private ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown knudLuminosity;
        private ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown knudHue;
        private ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown knudBlue;
        private ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown knudGreen;
        private ComponentFactory.Krypton.Toolkit.KryptonComboBox kcmbHex;
        private ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown knudAlpha;
        private ExtendedColourControls.RGBAColourSlider rColourBar;
        private ExtendedColourControls.RGBAColourSlider gColourBar;
        private ExtendedColourControls.RGBAColourSlider bColourBar;
        private ExtendedColourControls.HueColourSlider hColourBar;
        private ExtendedColourControls.LightnessColourSlider lColourBar;
        private ExtendedColourControls.SaturationColourSlider sColourBar;
        private ExtendedColourControls.RGBAColourSlider aColourBar;

        private void InitializeComponent()
        {
            this.klblRGB = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            ...
            this.klblHex = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.klblAlpha = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.klblLuminosity = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            ...
            this.klblHSL = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.knudRed = new ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown();
            this.knudSaturation = new ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown();
            this.knudLuminosity = new ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown();
            this.knudHue = new ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown();
            this.knudBlue = new ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown();
            this.knudGreen = new ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown();
            this.kcmbHex = new ComponentFactory.Krypton.Toolkit.KryptonComboBox();
            this.knudAlpha = new ComponentFactory.Krypton.Toolkit.KryptonNumericUpDown();
            this.rColourBar = new ExtendedColourControls.RGBAColourSlider();
