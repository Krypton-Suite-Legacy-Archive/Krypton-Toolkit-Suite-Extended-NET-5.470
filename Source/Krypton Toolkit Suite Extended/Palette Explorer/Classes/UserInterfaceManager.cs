...
namespace PaletteExplorer.Classes
{
    public class UserInterfaceManager
    {
        ...
        public static void FactoryPictureboxLocation(KryptonGroupBox standardColourPreviewPane, PictureBox baseColourPreview, PictureBox darkColourPreview, PictureBox middleColourPreview, PictureBox lightColourPreview, PictureBox lightestColourPreview, PictureBox borderColourPreview, PictureBox alternativeNormalTextColourPreview, PictureBox normalTextColourPreview, PictureBox disabledTextColourPreview, PictureBox focusedTextColourPreview, PictureBox pressedTextColourPreview, PictureBox disabledColourPreview, PictureBox linkNormalColourPreview, PictureBox linkHoverColourPreview, PictureBox linkVisitedColourPreview, PictureBox customColourOne, PictureBox customColourTwo, PictureBox customColourThree, PictureBox customColourFour, PictureBox customColourFive, PictureBox customTextColourOne, PictureBox customTextColourTwo, PictureBox customTextColourThree, PictureBox customTextColourFour, PictureBox customTextColourFive, PictureBox menuTextColourPreview, PictureBox statusTextColourPreview)
        {
            ...
            linkHoverColourPreview.Location = new Point(613, 127);

            linkVisitedColourPreview.Location = new Point(19, 239);

            customColourOne.Location = new Point(118, 239);

            customColourTwo.Location = new Point(217, 239);

            customColourThree.Location = new Point(316, 239);

            customColourFour.Location = new Point(415, 239);

            customColourFive.Location = new Point(514, 239);

            customTextColourOne.Location = new Point(613, 239);

            customTextColourTwo.Location = new Point(19, 351);

            customTextColourThree.Location = new Point(118, 351);

            customTextColourFour.Location = new Point(217, 351);

            customTextColourFive.Location = new Point(316, 351);

            menuTextColourPreview.Location = new Point(415, 351);

            statusTextColourPreview.Location = new Point(514, 351);
        }
        ...
        {
            standardColourPreviewPane.Size = new Size(1195, 467);
            ...
            linkHoverColourPreview.Location = new Point(235, 182);

            linkVisitedColourPreview.Location = new Point(343, 182);

            customColourOne.Location = new Point(451, 182);

            customColourTwo.Location = new Point(559, 182);

            customColourThree.Location = new Point(667, 182);

            customColourFour.Location = new Point(775, 182);

            customColourFive.Location = new Point(883, 182);

            customTextColourOne.Location = new Point(991, 182);

            customTextColourTwo.Location = new Point(1099, 182);

            customTextColourThree.Location = new Point(19, 350);

            customTextColourFour.Location = new Point(127, 350);

            customTextColourFive.Location = new Point(235, 350);

            menuTextColourPreview.Location = new Point(343, 350);

            statusTextColourPreview.Location = new Point(451, 350);
        }
    }
}