...
namespace ColourComposer.Classes
{
    ...
    {
        private static readonly CustomisableColourTable CustomColourTable = new CustomisableColourTable();

        public CustomToolStripRenderer()
            : base(CustomColourTable)
        {
        }
        ...
        /// </summary>
        /// <value></value>
        /// <returns>The <see cref="CustomColourTable"/> used for painting.</returns>
        public new CustomisableColourTable ColourTable
        {
            get { return CustomColourTable; }
        }

        #region Rendering Improvements (includes fixes for bugs occurred when Windows Classic theme is on).
        /*
