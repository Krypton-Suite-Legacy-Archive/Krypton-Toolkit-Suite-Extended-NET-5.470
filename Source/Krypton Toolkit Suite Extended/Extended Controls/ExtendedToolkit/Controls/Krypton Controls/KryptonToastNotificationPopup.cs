...
using ExtendedControls.ExtendedToolkit.UI.ToastNotification;
using System;
...
namespace ExtendedControls.ExtendedToolkit.Controls
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(KryptonToastNotificationPopup), "ToolboxBitmaps.KR 48 x 48 Orange.ico"), DefaultEvent("Click")]
