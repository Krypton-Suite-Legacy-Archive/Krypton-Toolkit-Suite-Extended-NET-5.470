...
namespace ExtendedControls.ExtendedToolkit.FileBrowserExtensions.Shell.Classes
{
    internal static class ShellHelper
    {
        ...
        public static bool GetIDropTarget(ShellItem item, out IntPtr dropTargetPtr, out Interfaces.IDropTarget dropTarget)
        {
            ...
            {
                dropTarget =
                    (Interfaces.IDropTarget)Marshal.GetTypedObjectForIUnknown(dropTargetPtr, typeof(Interfaces.IDropTarget));
