...
namespace ExtendedControls.ExtendedToolkit.ToolstripControls
{
    ...
    public class MenuStripMRUManager : KryptonMostRecentlyUsedFileMenuItem
    {
        /// <summary>
        ...
        private class MenuStripMenuBuilder : IMenuBuilder
        {
            ...
            public void RebuildMenus(IEnumerable<string> files, Action<string> fileMenuItemClick, string clearListMenuItemText = null, Action clearListMenuItemClick = null)
            {
                if (RecentFileMenuItem != null)
                {
                    ...
                    files.ForEach(f => RecentFileMenuItem.DropDownItems.Add(new ToolStripMenuItem(CompactPath(f, RecentFileMenuItem.Font, RecentFileMenuItem.Width), null, OnFileMenuItemClick) { Tag = f }));
