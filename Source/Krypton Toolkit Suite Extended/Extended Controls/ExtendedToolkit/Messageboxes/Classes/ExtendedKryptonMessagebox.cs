...
namespace ExtendedControls.ExtendedToolkit.MessageBoxes.UI
{
	...
	public class ExtendedKryptonMessageBox : KryptonForm
	{
		...
		public static DialogResult Show(IWin32Window owner, 
										...
										bool? showCtrlCopy = null, Font messageboxTypeface = null, bool showDoNotShowAgainOption = false,
		...
		{
			return InternalShow(owner, text, caption, buttons, icon, defaultButton, options, new HelpInformation(helpFilePath, navigator, param), showCtrlCopy, messageboxTypeface, showDoNotShowAgainOption, doNotShowAgainOptionText, useTimeOutOption, timeOut, timeOutDelay, defaultTimeOutResponse);
		}
		#endregion
