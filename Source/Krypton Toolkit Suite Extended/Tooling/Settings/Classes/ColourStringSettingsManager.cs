...
namespace Tooling.Settings.Classes
{
    public class ColourStringSettingsManager
    {
        ...
        {
            _colourStringSettings.DarkestColour = darkestColour;
        }
        ...
        {
            return _colourStringSettings.DarkestColour;
        }
        ...
        {
            _colourStringSettings.DisabledColour = disabledColour;
        }
        ...
        {
            return _colourStringSettings.DisabledColour;
        }
        ...
        {
            _colourStringSettings.StatusTextColour = statusTextColour;
        }
        ...
        {
            return _colourStringSettings.StatusTextColour;
        }
        #endregion
