...
namespace ExtendedStandardControls
{
    ...
    {
        #region Variables
        private Color _overrideFocusBackgroundColourOne, _overrideFocusBackgroundColourTwo, _overrideFocusItemBackgroundColourOne, _overrideFocusItemBackgroundColourTwo, _overrideFocusLongTextColourOne, _overrideFocusLongTextColourTwo, _overrideFocusShortTextColourOne, _overrideFocusShortTextColourTwo,
                      _stateActiveBackgroundColourOne, _stateActiveBackgroundColourTwo, _stateActiveItemBackgroundColourOne, _stateActiveItemBackgroundColourTwo, _stateActiveLongTextColourOne, _stateActiveLongTextColourTwo, _stateActiveShortTextColourOne, _stateActiveShortTextColourTwo,
                      _stateCheckedNormalBackgroundColourOne, _stateCheckedNormalBackgroundColourTwo, _stateCheckedNormalItemBackgroundColourOne, _stateCheckedNormalItemBackgroundColourTwo, _stateCheckedNormalLongTextColourOne, _stateCheckedNormalLongTextColourTwo, _stateCheckedNormalShortTextColourOne, _stateCheckedNormalShortTextColourTwo,
                      _stateCheckedPressedBackgroundColourOne, _stateCheckedPressedBackgroundColourTwo, _stateCheckedPressedItemBackgroundColourOne, _stateCheckedPressedItemBackgroundColourTwo, _stateCheckedPressedLongTextColourOne, _stateCheckedPressedLongTextColourTwo, _stateCheckedPressedShortTextColourOne, _stateCheckedPressedShortTextColourTwo,
                      _stateCheckedTrackingBackgroundColourOne, _stateCheckedTrackingBackgroundColourTwo, _stateCheckedTrackingItemBackgroundColourOne, _stateCheckedTrackingItemBackgroundColourTwo, _stateCheckedTrackingLongTextColourOne, _stateCheckedTrackingLongTextColourTwo, _stateCheckedTrackingShortTextColourOne, _stateCheckedTrackingShortTextColourTwo,
                      _stateCommonBackgroundColourOne, _stateCommonBackgroundColourTwo, _stateCommonItemBackgroundColourOne, _stateCommonItemBackgroundColourTwo, _stateCommonLongTextColourOne, _stateCommonLongTextColourTwo, _stateCommonShortTextColourOne, _stateCommonShortTextColourTwo,
                      _stateDisabledBackgroundColourOne, _stateDisabledBackgroundColourTwo, _stateDisabledItemBackgroundColourOne, _stateDisabledItemBackgroundColourTwo, _stateDisabledLongTextColourOne, _stateDisabledLongTextColourTwo, _stateDisabledShortTextColourOne, _stateDisabledShortTextColourTwo,
                      _stateNormalBackgroundColourOne, _stateNormalBackgroundColourTwo, _stateNormalItemBackgroundColourOne, _stateNormalItemBackgroundColourTwo, _stateNormalLongTextColourOne, _stateNormalLongTextColourTwo, _stateNormalShortTextColourOne, _stateNormalShortTextColourTwo,
                      _statePressedBackgroundColourOne, _statePressedBackgroundColourTwo, _statePressedItemBackgroundColourOne, _statePressedItemBackgroundColourTwo, _statePressedLongTextColourOne, _statePressedLongTextColourTwo, _statePressedShortTextColourOne, _statePressedShortTextColourTwo,
                      _stateTrackingBackgroundColourOne, _stateTrackingBackgroundColourTwo, _stateTrackingItemBackgroundColourOne, _stateTrackingItemBackgroundColourTwo, _stateTrackingLongTextColourOne, _stateTrackingLongTextColourTwo, _stateTrackingShortTextColourOne, _stateTrackingShortTextColourTwo;
        ...
        private void UpdateStateActiveAppearanceValues(Color backgroundColourOne, Color backgroundColourTwo)
        {
