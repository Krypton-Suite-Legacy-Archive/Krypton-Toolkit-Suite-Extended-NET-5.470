...
namespace ExtendedDocking
{
    ...
    #region DockingExtender
    public sealed class DockingExtender
    {
        ...
        public DockingExtender(Control dockHost)
        {
            _dockHost = dockHost;
        ...
        {
            IFloatingWindow f = _floaties.Find(container);
            if (f != null) f.Show();
        }
        ...
        internal Control FindDockHost(FloatingWindow floaty, Point pt)
        {
            Control c = null;
            ...
            foreach (FloatingWindow f in Floaties)
            {
