...
using TaskDialogs.Classes;
using TaskDialogButtonStruct = TaskDialogs.Classes.TaskDialogNativeMethods.TASKDIALOG_BUTTON;
using TaskDialogCallbackDelegate = TaskDialogs.Classes.TaskDialogNativeMethods.PFTASKDIALOGCALLBACK;
using TaskDialogConfig = TaskDialogs.Classes.TaskDialogNativeMethods.TASKDIALOGCONFIG;
...
using TaskDialogMessage = TaskDialogs.Classes.TaskDialogNativeMethods.TASKDIALOG_MESSAGES;
using TaskDialogNotification = TaskDialogs.Classes.TaskDialogNativeMethods.TASKDIALOG_NOTIFICATIONS;
using TaskDialogTextElement = TaskDialogs.Classes.TaskDialogNativeMethods.TASKDIALOG_ELEMENTS;

namespace TaskDialogs.Controls
{
    /// <summary>
