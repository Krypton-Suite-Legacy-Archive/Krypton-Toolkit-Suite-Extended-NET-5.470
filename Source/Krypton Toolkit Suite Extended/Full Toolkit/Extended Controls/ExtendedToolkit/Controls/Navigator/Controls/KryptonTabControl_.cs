#region License
/* KryptonTabControl.cs
 * A simple TabControl for use with the Krypton Toolkit.
 * 
 * License
 * 
 ...
 *  - Updated RefreshPalette() to update the control when
 *    it is triggered for better design-time suppport
 * 
 * 1.00
 *  - Initial control based on "Simple TabControl" by Kỳ Nam
 *    http://www.componentfactory.com/forums/viewtopic.php?f=7&t=1234
 *  - Aligned tabs better with left edge
 *  - Added border around selected tab
 *  - Fixed empty background when not using visual styles
 * 
 * TODO:
 *  - Fix drawing for all Alignments (Bottom, Left, Right)
 *    and Appearances (Buttons, FlatButtons)
 *  
 */
#endregion
...
namespace ExtendedControls.ExtendedToolkit.Controls.Navigator.Controls.Alternative
{
