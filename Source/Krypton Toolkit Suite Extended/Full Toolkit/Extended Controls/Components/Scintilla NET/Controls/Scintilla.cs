...
using ExtendedControls.Components.ScintillaNET.Enumerations;
using ExtendedControls.Components.ScintillaNET.EventArgumentHandlers;
using ExtendedControls.Components.ScintillaNET.Interfaces;
using ExtendedControls.Components.ScintillaNET.Structs;
using System;
...
namespace ExtendedControls.Components.ScintillaNET.Controls
{
    /// <summary>
    ...
    public class Scintilla : Control
    {
        ...
        {
            if (String.IsNullOrEmpty(name))
                return Enumerations.PropertyType.BOOLEAN;
        ...
        */
        ...
        /// </summary>
        /// <returns>One of the <see cref="Enumerations.Lexer" /> enumeration values. The default is <see cref="ScintillaNET.Enumerations.Lexer.CONTAINER" />.</returns>
        ...
        */
        ...
        /// </returns>
        /// <seealso cref="ViewWhitespace" />
        [DefaultValue(Enumerations.TabDrawMode.LONGARROW)]
        [Category("Whitespace")]
        [Description("Style of visible tab characters.")]
        public Enumerations.TabDrawMode TabDrawMode
        {
            get
            {
                return (Enumerations.TabDrawMode)DirectMessage(NativeMethods.SCI_GETTABDRAWMODE);
            }
            set
            {
